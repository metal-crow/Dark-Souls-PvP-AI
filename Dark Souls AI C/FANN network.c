...
int main1()
{
    ...
    train_data = fann_read_train_from_file("E:/Code Workspace/.external libraries/FANN-2.2.0-Source/datasets/parity8.train");
    test_data = fann_read_train_from_file("E:/Code Workspace/.external libraries/FANN-2.2.0-Source/datasets/parity8.test");
